...
"""See docstring for AdobePepperFlashDownloadDecoder class"""
...
__all__ = ["AdobePepperFlashDownloadDecoder"]

#pylint: disable=missing-docstring
#pylint: disable=e1101

class AdobePepperFlashDownloadDecoder(Processor):
    '''Decodes an Adobe Pepper Flash Download using `security cms`. Thanks to Per
    ...
    def main(self):
        ...
        outname = self.env.get("NAME", "AdobePepperFlashPlayer") + ".dmg"
...
if __name__ == '__main__':
    PROCESSOR = AdobePepperFlashDownloadDecoder()
