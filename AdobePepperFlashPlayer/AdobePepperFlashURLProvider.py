...
UPDATE_XML_URL = ("http://fpdownload2.macromedia.com/"
                  "get/flashplayer/update/current/xml/version_en_mac_pep.xml")
...
class AdobePepperFlashURLProvider(Processor):
    ...
    def get_adobeflash_dmg_url(self, headers=None, opts=None):
        '''Return the URL for the Adobe Pepper Flash DMG'''
    ...
    def main(self):
        '''Return a download URL for latest Mac PepperFlash Player'''
